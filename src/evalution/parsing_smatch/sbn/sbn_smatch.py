...
def create_arg_parser():
    ...
    parser.add_argument("-s1", '--sbn_file', default="/Users/xiaozhang/code/Parallel-Meaning-Bank-5/data/pmb-5.1.0/seq2seq/nl/test/standard.sbn", type=str,
                        help="file path of first sbn, one independent sbn should be in one line")
    parser.add_argument("-s2", '--sbn_file2', default="/Users/xiaozhang/code/Parallel-Meaning-Bank-5/results/parsing_pre_train/nl/google-mt5-base/standard.sbn", type=str,
...
if __name__ == '__main__':
    ...
    if len(sbn_data) != len(sbn_data2):
        ...
        for i in range(len(sbn_data)):
            ...
            try:
                sbn2 = sbn_data2[i].split("\t")[-1].strip()
